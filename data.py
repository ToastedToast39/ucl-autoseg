...
SEG_CLASS_MAP: dict[str, int] = {
    # Five anatomical classes the model must learn to locate the UCL.
    # The UCL lives in the space between humerus (class 2) and ulna (class 3),
    # tucked under the flexor/pronator mass (class 4).
    # Same logic as TotalSpineSeg: understand surrounding context first,
    # then the target structure (UCL) becomes precise.
    "ucl":              1,   # UCL ligament body
    "humerus":          2,   # humeral bone surface / trochlea
    "ulna":             3,   # ulnar bone surface / sublime tubercle
    "flexor_pronator":  4,   # flexor/pronator muscle mass superficial to UCL
}
NUM_SEG_CLASSES = 5   # 0=bg, 1=ucl, 2=humerus, 3=ulna, 4=flexor_pronator
